...
abstract class CommentsRepository {
  ...
  Future<Either<Failure, void>> approveComment(String siteId, int commentId);

  Future<Either<Failure, void>> deleteComment(String siteId, int commentId);

  Future<Either<Failure, void>> spamComment(String siteId, int commentId);

  Future<Either<Failure, int>> getPendingCommentsCount(String siteId);

  Future<Either<Failure, CommentEntity>> updateComment(
      String siteId, CommentEntity comment);
}
