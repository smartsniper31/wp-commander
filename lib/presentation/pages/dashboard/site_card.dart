...
class SiteCard extends ConsumerWidget {
  ...
  Widget _buildQuickStats() {
    return Row(
      ...
      children: [
        _buildStatItem(Icons.article, 'Articles', '24'),
        _buildStatItem(Icons.comment, 'Commentaires', '12'),
        _buildStatItem(Icons.health_and_safety, 'Santé', '85%'),
  ...
  void _navigateToSiteDetail(BuildContext context, SiteEntity site) {
    // context.push('${AppRoutes.siteDetail}?id=${site.id}');
  }
